...
def run(mode: str = "smoke", output_dir: str | Path = "reports", criteo_path: str | Path | None = None, seed: int = 2025) -> dict[str, object]:
    ...
    business_case=run_business_case(seed=seed, n_users=500, bootstrap_repetitions=500)
    ...
    manifest={"mode":mode,"seed":seed,"rows":len(frame),"estimate":estimate.__dict__,"policy_value_estimate":policy_point,"business_case_claim":canonical_claim,"platform":platform.python_version(),"inputs":{}}
